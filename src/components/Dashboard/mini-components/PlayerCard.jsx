      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <div className="text-sm flex items-center">
            ...
            ></span>
            <span className="text-gray-400">| {player.team}</span> <span className={`ml-2 px-2 py-0.5 text-xs rounded-full ${
              ...
              {player.status === "batting" ? "Playing" : player.status === "" ? "Pending" : "OUT"}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between mt-2 text-sm">
        <div>
         <span className="text-green-500 ">
            <span className="text-white">Dots:</span> {player.balls - (player.Fours * 1) - (player.Sixes * 1) - (player.score - (player.Fours * 4) - (player.Sixes * 6))} &nbsp;|&nbsp;
